...
#    Updated: 2022/05/22 21:12:07 by ahmez-za         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS_SRCS = checker.c push_swap_helper.c push_swap_helper2.c push_swap_helper3.c parsing_input.c push_to_stack_b.c push_to_stack_b_helpers.c push_to_stack_a.c sort_three_five.c
NAME = push_swap
BONUS_NAME = checker
LIBFT = ./libft/libft.a
